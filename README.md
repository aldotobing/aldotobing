...
[![My Skills](https://skillicons.dev/icons?i=java,go,javascript,typescript,postgres,docker,linux,bash,nginx,redis,aws,git,bitbucket&theme=dark)](https://skillicons.dev)
